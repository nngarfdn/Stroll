...
public class DestinasiHelper {
    ...
    private static DestinasiHelper INSTANCE;
    private static SQLiteDatabase database;

    private DestinasiHelper(Context context) {
        dataBaseHelper = new DatabaseHelper(context);
    }

    public static DestinasiHelper getInstance(Context context) {
        if (INSTANCE == null) {
            synchronized (SQLiteOpenHelper.class) {
                if (INSTANCE == null) {
                    INSTANCE = new DestinasiHelper(context);
                }
            }
        }
        return INSTANCE;
