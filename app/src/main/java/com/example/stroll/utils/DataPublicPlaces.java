...
public class DataPublicPlaces {
    ...
    private static String[] photoPublicPlaces = {
    ...
    private static String[] namaPublicPlaces = {
            "Taman Sari",
            "Taman Pintar",
            "Titik 0 KM",
    ...
    private static String[] deskripsiPublicPlaces = {
    ...
    private static String[] alamatPublicPlaces = {
