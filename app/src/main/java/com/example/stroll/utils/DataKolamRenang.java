...
public class DataKolamRenang {
    ...
    private static String[] photoKolamRenang = {
    ...
    private static String[] namaKolamRenang = {
    ...
    private static String[] deskripsiKolamRenang = {
    ...
    private static String[] alamatKolamRenang = {
