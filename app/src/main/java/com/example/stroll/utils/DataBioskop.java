...
public class DataBioskop {
    ...
    private static final String[] photoBioskop = {
    ...
    private static final String[] namaBioskop = {
            "Empire XXI",
    ...
    private static final String[] deskripsiBioskop = {
    ...
    private static final String[] alamatBioskop = {
