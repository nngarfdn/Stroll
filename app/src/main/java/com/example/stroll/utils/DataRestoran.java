...
public class DataRestoran {
    ...
    private static final String[] photoRestoran = {
    ...
    private static final String[] namaRestoran = {
            "Silol",
            "Kebon Ndalem",
    ...
    private static final String[] deskripsiRestoran = {
    ...
    private static final String[] alamatRestoran = {
